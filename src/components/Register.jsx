  ...
  return (
    ...
    >
      ...
      >
        {/* Welcome Section */}
        <motion.div 
          className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-4 sm:p-6 mb-8 border border-purple-200 dark:border-purple-700 relative overflow-hidden"
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              Create your account to start tracking your business performance with AI-powered insights and analytics.
            </motion.p>
        ...
        {/* Register Form Card */}
        <div className="bg-[var(--secondary-bg)] rounded-xl shadow p-4 sm:p-8 border border-[var(--border)]">
          <div className="flex items-center gap-3 mb-6">
            <FaUserPlus className="text-xl sm:text-2xl text-purple-500" />
            <h2 className="text-lg sm:text-xl font-semibold bg-gradient-to-r from-purple-500 to-pink-600 bg-clip-text text-transparent">Create Your Account</h2>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <input
              ...
              onChange={(e) => setProfilePicture(e.target.files[0])}
                className="w-full p-3 border border-[var(--border)] rounded-lg text-[var(--text-primary)] bg-[var(--secondary-bg)] focus:ring-2 focus:ring-[var(--accent)] focus:border-transparent transition-all file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-purple-50 file:text-purple-700 hover:file:bg-purple-100 dark:file:bg-purple-900/30 dark:file:text-purple-300"
            />
          </div>

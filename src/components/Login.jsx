      ...
      >
        ...
        >
          <div className="flex flex-wrap gap-3 sm:gap-6 items-center">
            <button onClick={() => navigate('/dashboard')} className="text-blue-600 hover:underline font-semibold flex items-center gap-2 text-2xl sm:text-3xl px-3 py-2 sm:px-4 sm:py-2 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400">
              <FaBoxOpen /> <span className="hidden sm:inline">Dashboard</span>
            </button>
            <button onClick={() => navigate('/business-data')} className="text-green-600 hover:underline font-semibold flex items-center gap-2 text-2xl sm:text-3xl px-3 py-2 sm:px-4 sm:py-2 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-green-400">
              <FaDatabase /> <span className="hidden sm:inline">Business Data</span>
            </button>
            <button onClick={() => navigate('/profit-loss')} className="text-purple-600 hover:underline font-semibold flex items-center gap-2 text-2xl sm:text-3xl px-3 py-2 sm:px-4 sm:py-2 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-purple-400">
              <FaCalculator /> <span className="hidden sm:inline">Profit/Loss</span>
            </button>
            <button onClick={() => navigate('/goals')} className="text-orange-600 hover:underline font-semibold flex items-center gap-2 text-2xl sm:text-3xl px-3 py-2 sm:px-4 sm:py-2 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-orange-400">
              <FaBullseye /> <span className="hidden sm:inline">Goals</span>
            </button>
            <button onClick={() => navigate('/login')} className="text-blue-600 hover:underline font-semibold flex items-center gap-2 text-2xl sm:text-3xl px-3 py-2 sm:px-4 sm:py-2 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400">
